...
** Date: August 17, 2015; Edited October 22 to shift population to 70+  Edited Nov 1 to take into account Ian's suggestions to 
* (1)	Remove graph title 
* (2)	Extend y, relative to x 
* (3)	Legend – make descriptions clearer. Can make text more wordy and show legend as a single column
** Purpose: Figure 3a
** 1990 to 2013
...
** Bring in draw data from IHME (received August 17, 2015)
		** insheet using "`folder'/Data/Prepped/death_draws_1990_2010.csv", comma clear 
		use "Data\allyears_decomp.dta", clear 
